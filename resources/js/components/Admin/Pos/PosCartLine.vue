...
<template>
    <div class="flex items-start gap-3 py-2.5">
        ...
        <!-- Body: full-width name on top, controls below -->
        <div class="grow min-w-0">
            <div class="flex items-start gap-2">
                <p
                    class="grow min-w-0 text-sm font-semibold leading-snug line-clamp-2 text-on-surface"
                    :title="line.productName"
                    data-testid="pos-cart-line-name"
                >
                    {{ line.productName }}
                </p>
                ...
                <!-- Remove -->
                <button
                    class="btn-icon w-7 h-7 shrink-0 -mt-0.5 -mr-0.5"
