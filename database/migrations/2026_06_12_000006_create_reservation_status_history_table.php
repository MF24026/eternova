...
/**
 * Append-only audit log for every reservation status transition.
 *
 * Design mirrors order_status_history exactly:
 ...
 *    was no prior status (the reservation was born directly into that status).
 ...
 *    row is scoped to the tenant that owns the reservation.
 *
 * reservation_id is unsignedBigInteger because reservations.id is a bigint
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('reservation_status_history', function (Blueprint $table): void {
            ...
            // Timeline queries: load history for one reservation sorted by time
