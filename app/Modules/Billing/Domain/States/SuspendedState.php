...
{
    public function name(): SubscriptionStatus { return SubscriptionStatus::Suspended; }

    public function canCharge(): bool { return true; }   // back-payment to restore
    ...
    public function isAccessible(): bool { return true; }   // visible but...

    public function isReadOnly(): bool { return true; }     // ...read-only
