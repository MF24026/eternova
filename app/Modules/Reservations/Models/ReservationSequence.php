...
/**
 * Per-tenant, per-year sequence counter for reservation numbers.
 *
 * This model is an implementation detail of ReservationService::nextReservationNumber()
 ...
 * requests.
 *
 * Mirrors OrderSequence exactly. See order_sequences migration for the concurrency
 * rationale.
 */
final class ReservationSequence extends Model
{
    use BelongsToTenant;

    protected $table = 'reservation_sequences';
